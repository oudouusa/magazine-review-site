...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/calendar`, lastModified: today, changeFrequency: "daily",   priority: 0.9 },
    { url: `${BASE}/trending`, lastModified: today, changeFrequency: "daily",   priority: 0.8 },
    { url: `${BASE}/covers`,   lastModified: today, changeFrequency: "weekly",  priority: 0.7 },
